export class DattaConfig {
  public static config = {
    ...
    'pre-layout': 'layout-6', // null, layout-2, layout-2-2, layout-3, layout-4, layout-4-2, layout-6, layout-8
    'collapse-menu': false,
    ...
    'nav-brand-color': 'brand-dark', // brand-default, brand-blue, brand-red, brand-purple, brand-lightblue, brand-dark
    ...
    'layout-6-background' : '#323437' // used only for pre-layout = layout-6
  };
}
